...
The current uncompressed size is `3345` bytes, the gzipped size is `1386` bytes and the brotli'd size is `1174` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.5.0/fixi.js >> fixi-0.5.0.js
```

The SHA256 of v0.5.0 is 

`TV/RaVUCIFNYSRlARltynwuS/utIkr7D/m3TzADTi2k=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.5.0.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.0/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-TV/RaVUCIFNYSRlARltynwuS/utIkr7D/m3TzADTi2k="></script>
```
