...
The current uncompressed size is `3463` bytes and the gzip'd size is `1401` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.3.0/fixi.js >> fixi-0.3.0.js
```

The SHA256 of v0.3.0 is 

`rdOlwYAx+lyV2o6oXyU0UFtvqKXvEtMFW/N2nse+4+A=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.3.0.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.3.0/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-rdOlwYAx+lyV2o6oXyU0UFtvqKXvEtMFW/N2nse+4+A="></script>
```
