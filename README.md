...
The current uncompressed size is `3388` bytes and the gzip'd size is `1385` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.4.1/fixi.js >> fixi-0.4.1.js
```

The SHA256 of v0.4.1 is 

`HqdVHV3yJT3B1hs9kIEH9h40sBR8P4sM0gAo2fo0Zp8=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.4.1.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.4.1/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-HqdVHV3yJT3B1hs9kIEH9h40sBR8P4sM0gAo2fo0Zp8="></script>
```
