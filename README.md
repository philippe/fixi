...
The current uncompressed size is `3293` bytes, the gzipped size is `1375` bytes and the brotli'd size is `1158` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.5.4/fixi.js >> fixi-0.5.4.js
```

The SHA256 of v0.5.4 is 

`i8gjDQPseO/IorJCrkK31YEFC0xLOwdXPDkDPMfD4V8=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.5.4.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.4/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-i8gjDQPseO/IorJCrkK31YEFC0xLOwdXPDkDPMfD4V8="></script>
```
