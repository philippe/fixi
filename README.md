...
The current uncompressed size is `3299` bytes, the gzipped size is `1370` bytes and the brotli'd size is `1159` bytes,
as determined by:
...
`UU6pHNAoifVzRM0PN0AoNm4E2eAacelex0k0DpwDXdQ=`
...
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.5/fixi.js"
        ...
        integrity="sha256-UU6pHNAoifVzRM0PN0AoNm4E2eAacelex0k0DpwDXdQ="></script>
```
