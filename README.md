...
The current uncompressed size is `3298` bytes, the gzipped size is `1371` bytes and the brotli'd size is `1152` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.5.2/fixi.js >> fixi-0.5.2.js
```

The SHA256 of v0.5.2 is 

`jZCDkaukeTNramwXFcgHT2VO8nU9h8c6xfJfhkDqdug=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.5.2.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.2/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-jZCDkaukeTNramwXFcgHT2VO8nU9h8c6xfJfhkDqdug="></script>
```
