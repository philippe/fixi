...
The current uncompressed size is `3413` bytes and the gzip'd size is `1405` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.4.2/fixi.js >> fixi-0.4.2.js
```

The SHA256 of v0.4.2 is 

`TxFacRCBnEiNBKGQvYY9ilGGbPSwQKAvt3OwVFv1mDQ=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.4.2.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.4.2/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-TxFacRCBnEiNBKGQvYY9ilGGbPSwQKAvt3OwVFv1mDQ="></script>
```
