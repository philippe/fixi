...
The current uncompressed size is `3278` bytes, the gzipped size is `1364` bytes and the brotli'd size is `1150` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.5.3/fixi.js >> fixi-0.5.3.js
```

The SHA256 of v0.5.3 is 

`12gBuT9nLYBOjUxYeZPsDjPG9V+rzDNByBLHNCELjW0=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.5.3.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.3/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-12gBuT9nLYBOjUxYeZPsDjPG9V+rzDNByBLHNCELjW0="></script>
```
