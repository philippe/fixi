...
The current uncompressed size is `3330` bytes, the gzipped size is `1378` bytes and the brotli'd size is `1171` bytes,
as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.5.1/fixi.js >> fixi-0.5.1.js
```

The SHA256 of v0.5.1 is 

`ZlUPQhIH7vBJnW6LdzqE2JToae9Pxl1UTa98pDop/vM=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.5.1.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.5.1/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-ZlUPQhIH7vBJnW6LdzqE2JToae9Pxl1UTa98pDop/vM="></script>
```
