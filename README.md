...
The current uncompressed size is `3479` bytes and the gzip'd size is `1389` bytes as determined by:
...
```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.2.2/fixi.js"
