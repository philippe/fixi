...
The current uncompressed size is `3408` bytes and the gzip'd size is `1388` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.4.0/fixi.js >> fixi-0.4.0.js
```

The SHA256 of v0.4.0 is 

`pjqP641nCCHaHU1zZGly01zIAKAsUfECcOItSdj6/w8=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.4.0.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.4.0/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-pjqP641nCCHaHU1zZGly01zIAKAsUfECcOItSdj6/w8="></script>
```
