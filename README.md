...
This fork of Fixi adds configuration options, inheritance of attributes, support for the target set to `"this"`, and a logger! All of this comes with a small addition of just 250 characters to the original code!
...
```html
<div target="this" swap="outerHTML">
...
The current uncompressed size is `3663` bytes and the gzip'd size is `1541` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/philippe/fixi/refs/tags/0.4.2/fixi.js >> fixi-0.4.2.js
```

The SHA256 of v0.4.2 is 

`hOYSyRfq/mzm1IZ5sl9cBCLOdLyD6K8JrQ/bS+j8j54=`
...
<https://github.com/philippe/fixi/archive/refs/tags/0.4.2.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/philippe/fixi@0.4.2/fixi.js"
