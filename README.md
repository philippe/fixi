...
The current uncompressed size is `3490` bytes and the gzip'd size is `1391` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.2.3/fixi.js >> fixi-0.2.3.js
```

The SHA256 of v0.2.3 is 

`I+biDkrj6BzW4+B9qnE/6e6JyVaiRLls45pRjcgGWUw=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.2.3.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.2.3/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-I+biDkrj6BzW4+B9qnE/6e6JyVaiRLls45pRjcgGWUw="></script>
```
